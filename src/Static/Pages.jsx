...
export default function Page() {
  ...
  return (
    <>
    <div className='max-w-[1250px] mx-auto overflow-x-hidden'>
    <header className=' max-h-[100px] fixed top-0 left-0 w-full z-50 flex justify-between items-center px-4 sm:px-8 lg:px-12 shadow-2xl pt-4'>
        ...
        <main className='hidden md:flex md:gap-10 md:items-center cursor-pointer'>
           <a href="#"> <nav className='text-red-600 hover:text-red-500'>Home</nav></a>
            ...
            <a href="#project"> <nav className='hover:text-gray-700'>Project</nav></a>
            ...
            <a href={cv} download="Joy Yakubu-CurriculumVitae"> <Button 
            title="Download cv"
            bgcolor="red"
            textcolor="white"
            /> </a>
           ...
           <section className='bg-gradient-to-br from-white via-gray-400 to-gray-100 flex flex-col md:flex-row justify-between items-center px-6 md:px-[50px] py-[60px] pt-[120px]'>
            ...
            <h1 className='font-bold text-red-600 text-3xl md:text-6xl pt-2'> Joy Yakubu</h1>
            ...
            textcolor="white"
            /> </a>
            <a href="https://github.com/Joeyakid?tab=repositories"><Button
            title="See my work"
            textcolor="black"
            borderColor="red"/></a>
            </span>
      ...
      <h1 className='font-bold text-3xl md:text-5xl text-center'>My Tech Stack</h1>
        <main className='grid grid-cols-4 sm-grid-cols-3 md:grid-cols-4 mt-10 lg:grid-cols-6 gap-[30px] md:gap-[70px]'>
      ...
      <section className='pt-15' ref={contactRef}>
      <Contact/>
      </section>
          <div>
